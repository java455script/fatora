...
<head>
    ...
    <title>توساليك البحث عن الفاتورة</title>
...
<header class="header  shHeader">
    ...
    <div class='box_inpt box_inpt2'>
        <input id='searchFilename' style='translate: 4px -2px;' class='search ipt_txt searchFilename' type='text' placeholder='أبحت عن الفتورة'>
...
<section class='box set'>
    ...
    <?php include_once 'show.php';?>
      ...
      <div class='boxNotFond'>
        ...
        <div class="boxTextNotF"><span>لم يتم العثور على فاتورة</span></div>
        <a class="my_btn" style='color:#fff;' href="fatora.php">انقر للعودة إلى البحث</a>
    </div>
